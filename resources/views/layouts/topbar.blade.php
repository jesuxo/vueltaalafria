        ...
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="d-md-none topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-dark rounded-circle" id="page-header-search-dropdown"
           ...
           e             <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
