        ...
        <div class="col-xxl-3 col-md-6">
            <div class="card card-height-100 bg-warning-subtle border-0 overflow-hidden">
                ...
                <div class="card-body p-4 z-1 position-relative">
                    <h4 class="fs-22 fw-semibold mb-3"><span class="depositoscounter counter-value" data-target="{{count($depositos)}}"></span> </h4>
                    <p class="mb-0 fw-medium text-uppercase fs-14">  Deposito<?php if(count($depositos)!=1)echo 's'?></p>
                </div>
            </div>
        </div>
                    ...
                    <div class="table-responsive table-card mb-1">
                        ...
                        <div class="noresult" style="display: none">
                            <div class="text-center py-4">
                                ...
                                <p class="text-muted mb-0">Hemos buscado en mas de {{count($depositos)}}+ Depositos registrados y
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header px-4 pt-4">
                    <h5 class="modal-title" id="exampleModalLabel">Informaci&oacute;n deposito nuevo</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                        id="close-modal"></button>
                </div>
                <form class="tablelist-form" novalidate action="{{route('depositos.create')}}" autocomplete="off" method="post">
                    @csrf
                    <div class="modal-body p-4">
                        ...
                        <div class="mb-3 input-group">
                            <div class="input-group-text">
                                <input class="form-check-input mt-0" type="checkbox" name="exhibicion" id="exhibicion-field"  value="1" aria-label="">
                            </div>
                        ...
                        <div class="mb-3 input-group">
                            <div class="input-group-text">
                                <input class="form-check-input mt-0" type="checkbox" name="venta" id="venta-field" value="1" aria-label="">
                            </div>
                        ...
                        <div class="mb-3 input-group">
                            <div class="input-group-text">
                                <input class="form-check-input mt-0" type="checkbox" id="servicio-field" name="servicio" value="1" aria-label="">
                            </div>
                        ...
                        <div  >
                            ...
                            <select class="form-control" required id="account-status-field">
                                <option value="">Seleccione el estatus del deposito</option>
...
@section('scripts')
    ...
    <!-- Sellers list js -->
    <script src="{{ URL::asset('build/js/backend/deposito-list.init.js') }}?version={{rand(0,500)}}"></script>
